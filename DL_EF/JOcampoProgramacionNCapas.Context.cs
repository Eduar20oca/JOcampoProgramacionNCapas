...
namespace DL_EF
{
    ...
    public partial class JOcampoProgramacionNCapasEntities1 : DbContext
    {
        public JOcampoProgramacionNCapasEntities1()
            : base("name=JOcampoProgramacionNCapasEntities1")
        {
        }
        ...
        public virtual ObjectResult<MunicipioByIdEstado_Result> MunicipioByIdEstado(Nullable<int> idEstado)
        {
            var idEstadoParameter = idEstado.HasValue ?
                new ObjectParameter("IdEstado", idEstado) :
                new ObjectParameter("IdEstado", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MunicipioByIdEstado_Result>("MunicipioByIdEstado", idEstadoParameter);
        }
        ...
        public virtual int UsuarioADD(string nombre, string apellidoPaterno, string apellidoMaterno, string userName, string email, string password, string sexo, string telefono, string celular, string fechaNacimiento, string cURP, Nullable<int> idRol, byte[] imagen, string calle, Nullable<int> numeroInterior, Nullable<int> numeroExterior, Nullable<int> idColonia)
        {
        ...
        public virtual int UsuarioADDTxt(string nombre, string apellidoPaterno, string apellidoMaterno, string userName, string email, string password, string sexo, string telefono, string celular, string fechaNacimiento, string cURP, Nullable<int> idRol)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioADDTxt", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, userNameParameter, emailParameter, passwordParameter, sexoParameter, telefonoParameter, celularParameter, fechaNacimientoParameter, cURPParameter, idRolParameter);
        }
        ...
        public virtual int UsuarioUpdate(Nullable<int> idUsuario, string nombre, string apellidoPaterno, string apellidoMaterno, string userName, string email, string password, string sexo, string telefono, string celular, string fechaNacimiento, string cURP, Nullable<int> idRol, byte[] imagen, string calle, Nullable<int> numeroInterior, Nullable<int> numeroExterior, Nullable<int> idColonia)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("IdUsuario", idUsuario) :
                new ObjectParameter("IdUsuario", typeof(int));
